...
<body>
	<%
		...
		String mid = (String)request.getAttribute("managerId");
		String ps = (String)request.getAttribute("managerPassword");
		if(mid == null){
			mid = "";
		}
		if(ps==null){
	...
	<h2>管理员登录</h2>
		...
		<h4 style="text-align: center;color:red;" ><%=request.getAttribute("error") %></h4>
		
		<form action = "/DXLibrary/ManagerLoginCheck" method = "post">
		<center>
			<table>
				<tr>
					<td style = "width: 40px;height: 30px;">账号</td>
					<td style = "width: 200px;height: 30px;"><input type = "text" name = "managerId" value = "<%=mid %>" style = "width: 200px;height: 20px;"/>
				</tr>
				<tr>
					<td style = "width: 40px;height: 30px;">密码</td>
					<td style = "width: 200px;height: 30px;"><input type = "password" name = "managerPassword" value = "<%=ps %>" style = "width: 200px;height: 20px;"/></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
		...
		<p>&nbsp;</p>
		<a href="/DXLibrary/login/userLogin.jsp" >学生登录</a>
	</div>
